...
class RandomErasing(object):
    ...
    def __init__(self, probability=0.5, sl=0.00005, sh=0.0001, r1=0.3, mean=[0.4914*255, 0.4822*255, 0.4465*255]):
    ...
    def __call__(self, results):
        ...
        for attempt in range(50):
            ...
            if w_ < w and h_ < h:
                ...
                img[0,x1:x1 + h_, y1:y1 + w_] = self.mean[0]
                img[1,x1:x1 + h_, y1:y1 + w_] = self.mean[1]
                img[2,x1:x1 + h_, y1:y1 + w_] = self.mean[2]
            results['img']=img
            # return results
